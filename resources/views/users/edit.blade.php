	...
	<div class="container">
		<div class="row">
			...
			<div class="col-12">
				...
				@endif
                @include('app.alerts')
				{!! Form::open(['url' => 'users/update/'.$data['row']->id, 'method' => 'put']) !!}					
				  	<div class="form-group row">
				  		{!! Form::label('user', 'Usuario', ['class' => 'col-sm-2 col-form-label']) !!}
					    <div class="col-sm-10">
					    	{!! Form::text('user', $data['row']->user, ['class' => 'form-control', 'autocomplete' => 'off', 'required' => 'on']) !!}
					    </div>
				  	</div>
				  	<div class="form-group row">
				  	...
				  	<div class="form-group row">
					    ...
					    <div class="col-sm-10">
					    	{!! Form::text('age', $data['row']->age, ['class' => 'form-control', 'autocomplete' => 'off', 'required' => 'on']) !!}
					    </div>
				  	</div>
				  	<div class="form-group row">
